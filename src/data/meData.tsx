...
const meData = [
  {
    text: [
      `I am currently working as a ${currentRole}. I have worn many different hats in my time, but I have always had a desire to know how things work. This has driven me throughout my life and various career focuses. I enjoy the challenge of creating something to achieve what I need, or fixing a problem, and then making things better.`,
